% Программа создаёт видеоанимацию (пока убрано) и .txt-файл с матрицами перекрываний нормальных и эффективных мод
...
for k = 1:numel(files)
    ...
    path_matrix = append(path, 'Матрицы сингулярные-нормальные\');
