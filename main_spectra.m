...
filename = 'C:\MATLAB\Эффективные моды\w3_4.irc';  %  путь к файлу, в конце символ \
t1 = {1};  %  начала траекторий - набор целых чисел
t2 = {100};  %  концы траектории - набор целых чисел: размерности t1 и t2 равны
vectors = [1];  %  интересующие векторы, диапазон можно задать так, например: 51:55
